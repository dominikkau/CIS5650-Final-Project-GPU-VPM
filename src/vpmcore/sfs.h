...
private:
    ...
    static __global__ void calculateTemporary(int N, ParticleBuffer particles, bool testFilter);

    static __global__ void calculateCoefficient(int N, ParticleBuffer particles, vpmfloat zeta0,
