...
public:
	...
	std::vector<double> _V_AB(const std::vector<double>& A, const std::vector<double>& B, const std::vector<double>& C, double gamma, bool ign_col);
	double dot(const std::vector<double>& v1, const std::vector<double>& v2);
	double magsqr(const std::vector<double>& v);
	std::vector<double> _V_Ainf_out(const std::vector<double>& A, const std::vector<double>& infD, const std::vector<double>& C, double gamma, bool ign_col);
	std::vector<double> _V_Ainf_in(const std::vector<double>& A, const std::vector<double>& infD, const std::vector<double>& C, double gamma, bool ign_col);
